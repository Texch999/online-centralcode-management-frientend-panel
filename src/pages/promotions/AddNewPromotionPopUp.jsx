      ...
      >
        ...
        <Modal.Body>
          ...
          <div className="row mt-3 small-font">
            ...
            {userPromotion===true?(  <></>):(  <div className="col-4 flex-column mt-2">
            ...
            <div className={`${userPromotion===true?"col-8":"col-4"} flex-column mt-2`}>
            ...
            <div className="row">
              ...
              <div className="saffron-btn2 small-font pointer mt-4 ms-3 col-3">
                Create
              </div>
            </div>
          </div>
