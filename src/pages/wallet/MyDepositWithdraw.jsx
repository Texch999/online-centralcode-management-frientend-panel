  ...
  return (
    <div>
      <div className="flex-between mb-3 mt-2">
        <h6 className="d-flex medium-font yellow-font mb-0">My Deposit & Withdraw</h6>
      ...
      <div className="w-100 flex-between mb-3 py-3 grey-bg2 rounded">
        <div className="col-3 ps-2 pe-1 ps-lg-3 pe-lg-3">
          <div className="white-btn2 flex-between">
            <span className="small-font">Sports Rental Amt.</span>
            <span className="medium-font green-font">100000000</span>
          </div>
        </div>
        <div className="col-3 pe-1 pe-lg-3">
          <div className="white-btn2 flex-between">
        ...
        <div className="col-3 pe-2 pe-lg-3">
          <div className="white-btn2 flex-between">
