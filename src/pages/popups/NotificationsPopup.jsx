...
const NotificationsPopup = ({
    ...
    const notifications = [
        // { id: 1, title: "Monthly report generated", message: "July month financial report is generated", time: "Apr 24, 10:30 AM", iconColor: "#36b4e5", hasAlert: false },
        // { id: 2, title: "Monthly report generated", message: "July month financial report is generated", time: "Apr 24, 10:30 AM", iconColor: "#a15eff", hasAlert: true },
        // { id: 3, title: "Monthly report generated", message: "July month financial report is generated", time: "Apr 24, 10:30 AM", iconColor: "#36b4e5", hasAlert: false },
        // { id: 4, title: "Monthly report generated", message: "July month financial report is generated", time: "Apr 24, 10:30 AM", iconColor: "#36b4e5", hasAlert: false }
    ];
    ...
    const modalStyle = notifications.length === 0
        ? { top: '62px', left: '77.5%', bottom: 'auto', width: '450px' }
        : { top: '62px', left: '77.5%', bottom: 'auto', width: '450px' }; 
    ...
    return (
        <Modal
            ...
            style={modalStyle} // Applying the conditional style here
            backdrop={false}
        >
                    ...
                    {notifications.length > 0 ? (
                        notifications.map((notification) => (
                            <div key={notification.id} className="d-flex align-items-start p-3 bg-white mb-1">
                                {renderIcon(notification.iconColor)}
                                <div className="flex-grow-1">
                                    <div className="d-flex justify-content-between align-items-start">
                                        <span className="fw-medium text-dark">{notification.title}</span>
                                        {notification.hasAlert && (
                                            <span className="rounded-circle"
                                                style={{ backgroundColor: "#ff9f10", width: "8px", height: "8px", display: "inline-block" }}></span>
                                        )}
                                    </div>
                                    <p className="mb-0 text-secondary small">{notification.message}</p>
                        ...
                        <div className="d-flex flex-column align-items-center justify-content-center p-3 mb-1" style={{ minHeight: "350px" }}>
                            <div className="mb-4 bg-light rounded-circle p-4 d-flex justify-content-center align-items-center" style={{ width: "310px", height: "50px" }}>
