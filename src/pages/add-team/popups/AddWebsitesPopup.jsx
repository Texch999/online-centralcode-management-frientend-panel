...
//     } else if (
//       !/^https?:\/\/(www\.)?([a-zA-Z0-9-]+\.)+[a-zA-Z]{2,}(:\d+)?(\/[^\s]*)?$/.test(
//         formData.websiteURL
//       )
//     ) {
...
//             <MdOutlineClose size={22} onClick={() => { resetData(); onHide() }} className="pointer" />
//           </div>
...
//             </button>
//           </div>
//           <span className="error-text small-font">{apiError}</span>
//         </Modal.Body>
//       </Modal>
//       <SuccessPopup
