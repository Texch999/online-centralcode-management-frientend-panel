...
function AddNewDirectorSuperAdmin() {
  ...
  const [firstSelectedAdmin, setFirstSelectedAdmin] = useState(null);
  ...
  const validateForm = () => {
    ...
    if (!selectedCountryCode) newErrors.selectedCountryCode = "Country is required.";
